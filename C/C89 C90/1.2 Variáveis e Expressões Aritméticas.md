...
1-3. Modifique o programa de conversão de temperatura para imprimir um cabeçalho acima da tabela.

1-4. Escreva um programa para imprimir a tabela de conversão de temperatura correspondente de Celsius para Fahrenheit.

Solução conjunta:
>![[conversor_temperatura 1.c]]
# ***Notas de Rodapé
