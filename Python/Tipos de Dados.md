...
Os números de ponto flutuante(números racionais) são representados pela clase *float*. São exemplos válidos:
1.6, -10.1456, 0.76...

# **Tipo Booleano

É usado para representar verdadeiro e falso, e é implementado pela classe *bool*. Em Python o tipo booleano é uma subclasse de int, uma vez que 0 representa falso e qualquer outro diferente de 0 verdadeiro. São exemplos válidos:
True e False
