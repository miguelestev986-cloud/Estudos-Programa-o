...
Além de acessar os itens diretamente, podemos extrair um conjunto de valores de uma sequência com o *fatiamento*. Para isso basta passar o índice inicial e/ou final para acessar o conjunto. Podemos informas quantas posições o cursor deve "pular" no acesso.
